...
// //coupan tab jquery working
// jQuery(document).ready(function(event){
//      // jQuery('input[name="apply_coupon"]').on('click', function() {
//     var coupancode = jQuery("#user_role").data('user');
//     alert("coupancode");
//         // event.preventDefault();
//     jQuery('.wpmc-billing').removeClass('current');
//     jQuery('.wpmc-review').addClass('current');
//     // jQuery(".wpmc-steps-wrapper").append('.main_review_for_coupan');
//     // jQuery('.wpmc-review').addClass('current');
//     // var htmlContent = jQuery(".wpmc-steps-wrapper").html();
//     // jQuery(".wpmc-steps-wrapper").html(htmlContent); // Set the HTML content of the display element
// });
